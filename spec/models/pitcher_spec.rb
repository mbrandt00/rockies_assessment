...
RSpec.describe Pitcher do 
    ...
    describe 'class methods' do 
        ...
        it '.search' do 
            pitcher_1 = Pitcher.create!(pitcher_name: 'Smith, Joe')
            pitcher_2 = Pitcher.create!(pitcher_name: 'Daniel, Joe')
            pitcher_3 = Pitcher.create!(pitcher_name: 'Sam, Hernandez')
            pitcher_4 = Pitcher.create!(pitcher_name: 'Alex, Hernando')
